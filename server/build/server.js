...
const convert_minutes_string_hour_1 = require("./utils/convert-minutes-string-hour");
...
app.get('/games/:id/ads', (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return response.json(ads.map(ad => {
        return Object.assign(Object.assign({}, ad), { weekDays: ad.weekDays.split(','), hourStart: (0, convert_minutes_string_hour_1.convertMinutesStringToHour)(ad.hourStart), hourEnd: (0, convert_minutes_string_hour_1.convertMinutesStringToHour)(ad.hourEnd) });
    }));
}));
